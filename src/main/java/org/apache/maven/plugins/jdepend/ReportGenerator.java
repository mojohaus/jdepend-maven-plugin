...
package org.apache.maven.plugins.jdepend;
...
import org.apache.maven.plugins.jdepend.JDependXMLReportParser;
import org.apache.maven.plugins.jdepend.objects.Stats;
import org.apache.maven.plugins.jdepend.objects.JDPackage;
import org.apache.maven.plugins.jdepend.objects.CyclePackage;
...
public class ReportGenerator
{
    ...
    public void doGenerateReport(ResourceBundle bundle, Sink sink, JDependXMLReportParser jdepend) throws MavenReportException
    {
        try
        {     
        ...
        throws MavenReportException
    {
        try
        {
            ...
            sink.text("The ratio of efferent coupling (Ce) to total coupling " +
                    ...
                    "I=0 indicating a completely stable package and I=1 indicating a " +
